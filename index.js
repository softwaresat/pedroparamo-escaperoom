...
app.get('/leaderboard', function (req, res) {
  ...
  app.post('/submit', function (req, res) {
        ...
        let counter = 0;
        if((stationNumber == 1 && response.toLowerCase() === "dorotea") || (stationNumber == 2 && response.toLowerCase() === "ghost") || (stationNumber == 3 && response.toLowerCase() === "") || (stationNumber == 4 && response.toLowerCase() === " pedro paramo eduviges father renteria dorotea")){
